    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (start == "ja")
            {
                ...
                if (h1.InLoveWithPrincess == true)
                {
                    ...
                    if (eten == "ja")
                    {
                        ...
                        System.Threading.Thread.Sleep(2000);
                        Console.WriteLine(h1.Name + " neemt afscheid van " + p1.Name + " en vervolgt zijn weg.");
                    }
                    else if (eten == "nee")
                    {
                ...
                {
                    Console.WriteLine("De prinses vindt " + h1.Name + " te lelijk en jaagt hem weg...");
                    Console.WriteLine(h1.Name + " is nu depresief...");
                    h1.Health -= 50;
                    Console.WriteLine(h1.Name + " heeft nu nog " + h1.Health + " hp over.");
                }
            ...
            else
            {
                ...
                {
                    Console.WriteLine("U done goofed m8.");
                    System.Threading.Thread.Sleep(1000);
